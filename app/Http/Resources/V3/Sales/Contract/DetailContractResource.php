...
use App\Http\Resources\V2\Sales\Contract\DraftContractDocumentResource;
use App\Http\Resources\V3\Sales\Contract\ContractJointOwnerCollection;
...
class DetailContractResource extends JsonResource
{
    public function toArray($request)
    {
        ...
        return [
            ...
            'hide_uk_documents' => $this->getHideUkDocuments()
        ];
    }
}
