...
use App\Http\Resources\V3\Sales\Demand\DemandCollection;
...
use App\Services\V3\Sales\Demand\DemandRepository;
 ...
 *
 * @package App\Http\Api\External\V3\Controllers\Sales
 */
class DemandController extends BaseSalesController
{
    ...
    public function index(): Response
    {
        ...
        $contracts = $this->contractRepository->getContracts($this->getAuthUser()->crm_id);
