...
namespace App\Services\V3\Sales\Customer;
...
use App\Models\V3\Sales\Customer\CustomerContractConfidant;
...
class CustomerContractConfidantRepository
{
    ...
    public function makeCustomer(array $data, array $customer): ?CustomerContractConfidant
    {
        ...
        return new CustomerContractConfidant(
            ...
            accountId: $data['accountId'] ?? null,
            confidant: $data['confidant']['code'] ?? null,
            jointOwnerId: $data['id'] ?? null,
            fullName: $fullName,
            ...
            label: $this->makeLabel($data['signatoryType']),
    ...
    private function makeLabel($signatoryType)
    {
